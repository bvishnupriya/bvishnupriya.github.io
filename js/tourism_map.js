...
if(typeof d.years!= "undefined"){
tooltip.html(
"<strong>Country: </strong><span class='details'>" + d.years[year][0].CountryName + "<br></span>" + "<strong>Arrivals: </strong><span class='details'>" +format(d.years[year][0].Value) +"</span>"
)
