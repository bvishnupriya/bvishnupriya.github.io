...
queue()
.defer(d3.csv,
"https://raw.githubusercontent.com/vishnupriya-b/CSV/master/WDIData_imports.csv")
.defer(d3.json,
...
d.Years =+d.Years;
d.Imports=d3.round(+d.Imports,2);
});

var importDataByYear = d3.nest()
...
if(typeof importDataByYear[id] != "undefined"){

country.years = importDataByYear[id];
}
});
